        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-5 col-md-6 margin-four-bottom md-margin-30px-bottom sm-margin-30px-bottom text-center">
                    <div class="alt-font text-light-gray margin-5px-bottom text-uppercase text-extra-large">Me mande uma mensagem</div>
                    <div class="alt-font text-medium-gray font-weight-400 line-height-30 text-medium">Assim que possível, entrarei em contato com você.</div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-lg-8 wow fadeIn text-center">
                        ...
                        <div class="loading">
                            <div class="content">
                                ...
                                <div class="alt-font text-small text-white text-uppercase">Enviando...</div>
                            </div>
                        </div>

                        <input type="text" name="name" id="name" placeholder="Nome *" class="input-border-bottom" required>
                        <input type="email" name="email" id="email" placeholder="E-mail *" class="input-border-bottom" required>
                        <input type="text" id="subject" name="subject" placeholder="Assunto" class="input-border-bottom" required>
                        <textarea name="message" id="message" placeholder="Mensagem" class="input-border-bottom" required></textarea>
