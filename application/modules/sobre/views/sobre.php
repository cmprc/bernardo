<div id="about">
    ...
    <div class="my-data">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-4 text-right md-text-center wow fadeIn">
                    <?php if (!empty($blocks['sobre-um-pouco-sobre-mim']->title)) { ?>
                        <h6 class="alt-font"><?= $blocks['sobre-um-pouco-sobre-mim']->title; ?></h6>
                    <?php } ?>
                    <div class="alt-font text-small text-gray text-about">
                        <?= $blocks['sobre-um-pouco-sobre-mim']->text; ?>
                    </div>
                </div>
                <div class="col-md-4 text-centers wow fadeIn" data-wow-delay=".2s">
                ...
                <div class="col-md-4 text-center wow fadeIn" data-wow-delay=".4s">
    ...
    <div class="projects">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4 col-md-6 md-margin-five-bottom md-padding-15px-left sm-margin-30px-bottom text-center wow fadeInUp">
                    ...
                    <div class="separator-line-verticle-large d-inline-block"></div>
                </div>
                <div class="col-12 col-lg-4 col-md-6 md-margin-five-bottom md-padding-15px-left sm-margin-30px-bottom text-center wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="col-12 col-lg-4 col-md-6 md-padding-15px-left sm-margin-30px-bottom text-center  wow fadeInUp" data-wow-delay="0.4s">
    ...
    <div class="why">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4 md-margin-40px-bottom text-right title-why-container sm-margin-30px-bottom">
                    <h6 class="text-white font-weight-300 alt-font m-0 width-80 sm-width-100 line-height-40 title-why">Por que meus <strong>serviços</strong> valem a pena?</h6>
                </div>
