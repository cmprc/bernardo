...
*
*
* Fixes para chamar a função slug
...
class MY_Upload extends CI_Upload {
        ...
        public function initialize($config = array()){
            ...
            if(!empty($this->file_name)){
                ...
                if(is_array($this->file_name)){
                    ...
                    $this->_multi_file_name_override = str_replace('-', '_', slug($this->file_name, null, null, '_', true));
                //Single file upload.
                } else {
                    //Set file name override.
                    $this->_file_name_override = str_replace('-', '_', slug($this->file_name, null, null, '_', true));
    ...
    protected function _prep_filename($filename)
    {
        ...
        $ext        = array_pop($parts);
        $filename   = str_replace('-', '_', slug(array_shift($parts), null, null, '_', true));
